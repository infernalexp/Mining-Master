...
public class MMConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> ORE_FIRE_RUBY_NATIVE = registerConfiguredFeature("ore_fire_ruby_native", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, MMBlocks.FIRE_RUBY_ORE.get().getDefaultState(), 1)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(12, 0, 48))).square().count(16));
    public static ConfiguredFeature<?, ?> ORE_ICE_SAPPHIRE_NATIVE = registerConfiguredFeature("ore_ice_sapphire_native", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, MMBlocks.ICE_SAPPHIRE_ORE.get().getDefaultState(), 1)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(12, 0, 48))).square().count(16));
    public static ConfiguredFeature<?, ?> ORE_SPIRIT_AMETHYST_NATIVE = registerConfiguredFeature("ore_spirit_amethyst_native", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, MMBlocks.SPIRIT_AMETHYST_ORE.get().getDefaultState(), 1)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(12, 0, 48))).square().count(16));
    public static ConfiguredFeature<?, ?> ORE_HASTE_PERIDOT_NATIVE = registerConfiguredFeature("ore_haste_peridot_native", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, MMBlocks.HASTE_PERIDOT_ORE.get().getDefaultState(), 1)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(12, 0, 48))).square().count(8));
    public static ConfiguredFeature<?, ?> ORE_LUCKY_CITRINE_NATIVE = registerConfiguredFeature("ore_lucky_citrine_native", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, MMBlocks.LUCKY_CITRINE_ORE.get().getDefaultState(), 1)).withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(12, 0, 48))).square().count(8));
