...
public class MMPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ORE_FIRE_RUBY_NATIVE = registerPlacedFeature("ore_fire_ruby_native", MMConfiguredFeatures.ORE_FIRE_RUBY_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(192)), BiomeFilter.biome());
