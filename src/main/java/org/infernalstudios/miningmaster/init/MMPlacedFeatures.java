...
public class MMPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ORE_FIRE_RUBY_NATIVE = registerPlacedFeature("ore_fire_ruby_native", MMConfiguredFeatures.ORE_FIRE_RUBY_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_ICE_SAPPHIRE_NATIVE = registerPlacedFeature("ore_ice_sapphire_native", MMConfiguredFeatures.ORE_ICE_SAPPHIRE_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_SPIRIT_GARNET_NATIVE = registerPlacedFeature("ore_spirit_garnet_native", MMConfiguredFeatures.ORE_SPIRIT_GARNET_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_DIVE_AQUAMARINE_NATIVE = registerPlacedFeature("ore_dive_aquamarine_native", MMConfiguredFeatures.ORE_DIVE_AQUAMARINE_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_HASTE_PERIDOT_NATIVE = registerPlacedFeature("ore_haste_peridot_native", MMConfiguredFeatures.ORE_HASTE_PERIDOT_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.rareGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_LUCKY_CITRINE_NATIVE = registerPlacedFeature("ore_lucky_citrine_native", MMConfiguredFeatures.ORE_LUCKY_CITRINE_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.rareGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(12), VerticalAnchor.belowTop(18)), BiomeFilter.biome());

    public static final Holder<PlacedFeature> ORE_POWER_PYRITE_NATIVE = registerPlacedFeature("ore_power_pyrite_native", MMConfiguredFeatures.ORE_POWER_PYRITE_NATIVE, CountPlacement.of(MiningMasterConfig.CONFIG.commonGemsPerChunk.get()), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome());
