...
public class MMItems {
    ...
    public static final RegistryObject<GemAxeItem> FIRE_RUBY_AXE = registerItem("fire_ruby_axe", () -> new GemAxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(FIRE_RUBY.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.FIRE_ASPECT, 3)));
    public static final RegistryObject<GemAxeItem> ICE_SAPPHIRE_AXE = registerItem("ice_sapphire_axe", () -> new GemAxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(ICE_SAPPHIRE.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(MMEnchantments.FREEZING, 3)));
    ...
    public static final RegistryObject<GemAxeItem> KINETIC_OPAL_AXE = registerItem("kinetic_opal_axe", () -> new GemAxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(KINETIC_OPAL.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.KNOCKBACK, 2), new Pair<>(MMEnchantments.SMELTING, 1)));
    public static final RegistryObject<GemAxeItem> ULTIMA_AXE = registerItem("ultima_axe", () -> new GemAxeItem(MMItemTiers.ULTIMA, Ingredient.fromItems(SPIRIT_GARNET.get(), POWER_PYRITE.get(), LUCKY_CITRINE.get(), HASTE_PERIDOT.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.SHARPNESS, 5), new Pair<>(() -> MMEnchantments.LEECHING.get(), 1), new Pair<>(() -> Enchantments.EFFICIENCY, 3), new Pair<>(() -> Enchantments.LOOTING, 3)));


    public static final RegistryObject<GemPickaxeItem> FIRE_RUBY_PICKAXE = registerItem("fire_ruby_pickaxe", () -> new GemPickaxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(FIRE_RUBY.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.FIRE_ASPECT, 1)));
    public static final RegistryObject<GemPickaxeItem> ICE_SAPPHIRE_PICKAXE = registerItem("ice_sapphire_pickaxe", () -> new GemPickaxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(ICE_SAPPHIRE.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(MMEnchantments.FREEZING, 1)));
    public static final RegistryObject<GemPickaxeItem> SPIRIT_GARNET_PICKAXE = registerItem("spirit_garnet_pickaxe", () -> new GemPickaxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(SPIRIT_GARNET.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> MMEnchantments.LEECHING.get(), 1)));
    ...
    public static final RegistryObject<GemShovelItem> POWER_PYRITE_SHOVEL = registerItem("power_pyrite_shovel", () -> new GemShovelItem(MMItemTiers.SUPRA, Ingredient.fromItems(POWER_PYRITE.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(MMEnchantments.STONEBREAKER, 1), new Pair<>(() -> Enchantments.SHARPNESS, 3)));
    public static final RegistryObject<GemShovelItem> LUCKY_CITRINE_SHOVEL = registerItem("lucky_citrine_shovel", () -> new GemShovelItem(MMItemTiers.SUPRA, Ingredient.fromItems(LUCKY_CITRINE.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.FORTUNE, 3)));
    ...
    public static final RegistryObject<GemHoeItem> LUCKY_CITRINE_HOE = registerItem("lucky_citrine_hoe", () -> new GemHoeItem(MMItemTiers.SUPRA, Ingredient.fromItems(LUCKY_CITRINE.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.FORTUNE, 3)));
