...
public class MMItems {
    ...
    public static final RegistryObject<GemAxeItem> SPIRIT_GARNET_AXE = registerItem("spirit_garnet_axe", () -> new GemAxeItem(MMItemTiers.SUPRA, Ingredient.fromItems(SPIRIT_GARNET.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(MMEnchantments.LEECHING, 1)));
    ...
    public static final RegistryObject<GemShovelItem> KINETIC_OPAL_SHOVEL = registerItem("kinetic_opal_shovel", () -> new GemShovelItem(MMItemTiers.SUPRA, Ingredient.fromItems(KINETIC_OPAL.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(MMEnchantments.SMELTING, 1)));
    public static final RegistryObject<GemShovelItem> ULTIMA_SHOVEL = registerItem("ultima_shovel", () -> new GemShovelItem(MMItemTiers.ULTIMA, Ingredient.fromItems(KINETIC_OPAL.get(), LUCKY_CITRINE.get(), HASTE_PERIDOT.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.EFFICIENCY, 4), new Pair<>(() -> Enchantments.FORTUNE, 1), new Pair<>(MMEnchantments.SMELTING, 1)));
    ...
    public static final RegistryObject<GemHoeItem> ULTIMA_HOE = registerItem("ultima_hoe", () -> new GemHoeItem(MMItemTiers.ULTIMA, Ingredient.fromItems(LUCKY_CITRINE.get(), HASTE_PERIDOT.get()), 5, 3.0F, new Item.Properties().group(MiningMaster.TAB), new Pair<>(() -> Enchantments.EFFICIENCY, 6), new Pair<>(() -> Enchantments.FORTUNE, 2)));
