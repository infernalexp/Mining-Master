...
public class MMItems {
    ...
    public static final RegistryObject<GemSwordItem> KINETIC_OPAL_SWORD = registerItem("kinetic_opal_sword", () -> new GemSwordItem(MMItemTiers.SUPRA, Ingredient.of(KINETIC_OPAL.get()), 3, -2.4F, new Item.Properties().tab(MiningMaster.TAB), new Pair<>(() -> Enchantments.KNOCKBACK, 3)));
    ...
    public static final RegistryObject<GemAxeItem> SPIRIT_GARNET_AXE = registerItem("spirit_garnet_axe", () -> new GemAxeItem(MMItemTiers.SUPRA, Ingredient.of(SPIRIT_GARNET.get()), 5, -3.0F, new Item.Properties().tab(MiningMaster.TAB), new Pair<>(() -> MMEnchantments.LEECHING.get(), 2)));
    ...
    public static final RegistryObject<GemPickaxeItem> POWER_PYRITE_PICKAXE = registerItem("power_pyrite_pickaxe", () -> new GemPickaxeItem(MMItemTiers.SUPRA, Ingredient.of(POWER_PYRITE.get()), 1, -2.8F, new Item.Properties().tab(MiningMaster.TAB), new Pair<>(MMEnchantments.STONEBREAKER, 1), new Pair<>(() -> Enchantments.SHARPNESS, 3)));
