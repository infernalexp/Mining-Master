...
public class GemSwordItem extends SwordItem {
    ...
    @SafeVarargs
    public GemSwordItem(Tier tier, Ingredient repairItems, int attackDamageIn, float attackSpeedIn, Properties builderIn, Pair<Supplier<Enchantment>, Integer>... enchantments) {
